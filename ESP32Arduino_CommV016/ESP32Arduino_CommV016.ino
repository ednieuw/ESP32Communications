...
byte NoConnectionCounter    = 0;                                                              // Count times minutes with no WIFI connection
                                                          // Count times minutes with no WIFI connection
//----------------------------------------                                                    //
// WPS
//----------------------------------------
...
void setup() 
{
 ...
 if(Mem.TimeReceiver) {LEDstartup(blue); StartTimeSenderScan();Tekstprintln("Time Sender started"); } // Time Sender app on iPhone can be used
if(Mem.TimeSender) BLETimeSenderStart();                                                         
...
{ 
 ...
 PrintLine(35);
 snprintf(sptext, sizeof(sptext),"Display off between: %02dh - %02dh",Mem.TurnOffLEDsAtHH, Mem.TurnOnLEDsAtHH);  WTekstprintln(sptext);                                                                  WTekstprintln(sptext);
