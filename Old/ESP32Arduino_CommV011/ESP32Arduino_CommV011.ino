...
Pin Numbering: Pin Numbering: By Arduino pin (default)   //By GPIO number (legacy).  'By Arduino pin (default)'
...
void setup() 
{
 ...
 GetTijd(false);                                                                              // Get the time
 LEDstartup(green);                                                                           // Set the status LED to green
 SWversion();                                                                                 // Print the menu + version                                                                       // Set the status LED to green                                  
...
// MCUled.begin();           // INITIALIZE MCU WS2812 RGB LED
// MCUled.show();            // Turn OFF all pixels ASAP
// MCUled.setBrightness(32);
