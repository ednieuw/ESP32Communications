 ...
 if (encoderPos == 0 )                                                                        // Set the time by pressing rotary button
   { 
    ...
    switch (NoofRotaryPressed)                                                                // No of times the rotary is pressed
      {
       case 1:  ChangeTime = true;            break;                    // Change the hours
       case 2:  ChangeTime = true;            break;                    // Change the hours        
       case 3:  ChangeLightIntensity = true;  break;                    // Turn on TWAALF and change intensity 
       case 4:                                                      break;                    // 
       case 5:                                                      break;                    // 
       case 6:                                                      break;                    // 
       case 7:                                                      break;                    //                                
