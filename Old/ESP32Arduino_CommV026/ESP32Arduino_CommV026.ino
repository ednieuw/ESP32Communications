/* 
 ...
 Changes V025: Also Comparable with ESP32_WordClockV200 
...
const char *menu[] = {
 ...
 "Q Time sender, H05 time receiver",
...
// snprintf(sptext, sizeof(sptext),"Password: %s", Mem.Password);                               WTekstprintln(sptext);
 ...
 snprintf(sptext, sizeof(sptext),"%s %s %s", Mem.WIFIOn?"WIFI=On":"WIFI=Off", 
 ...
 if(!Small) {snprintf(sptext, sizeof(sptext),"%s %s %s",Mem.UseRotary==0 ?"No Rotary, ":
  ...
  if(!Small) {snprintf(sptext, sizeof(sptext),"%s %s",
                               Mem.UseRotary==5?"TimeReceiver=On":"TimeReceiver=Off",
...
//--------------------------------------------                                                //
// CLOCK Say the time and load the LEDs with the proper colour and intensity
//--------------------------------------------
