...
31/05/2025 15:55:31
```
The software can be used on this PCB:[small PCB](https://github.com/ednieuw/Arduino-ESP32-Nano-Wordclock/PCB) but it can also be connected via the Arduino pins directly.
